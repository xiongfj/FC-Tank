...
namespace irrklang
{
	...
	class ISoundEffectControl	// 提供了九个音效
	{
	public:
		...
		// 压缩音效 Compressor
		virtual bool enableCompressorSoundEffect( ik_f32 fGain = 10,
												ik_f32 fAttack = 10,
												ik_f32 fRelease = 200,
		...
		// 唰唰音效 Gargle
		virtual bool enableGargleSoundEffect(ik_s32 rateHz = 20, 
											bool sinusWaveForm = true) = 0;
