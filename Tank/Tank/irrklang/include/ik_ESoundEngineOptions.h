...
namespace irrklang  
{
	//! An enumeration(枚举) for all options for starting up the sound engine

	/** When using createIrrKlangDevice, use a combination(组合) of this these
	as 'options' parameter(选择参数) to start up the engine. By default(默认值), irrKlang
